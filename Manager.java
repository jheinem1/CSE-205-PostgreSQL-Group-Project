...
public class Manager extends Person {
	...
	public void addNewItemToInventory(Inventory invent, String itemName, int itemPrice, int itemQuantity) {
		invent.createNewItem(itemName, itemPrice, itemQuantity);
	}
	
	public void incInventoryQuantityInventoryByOne(Inventory invent, String itemName) {
		invent.increaseQuantity(itemName);
	}
	
	public void decInventoryQuantityInventory(Inventory invent, String itemName, int decAmount) {
		invent.decreaseQuantity(itemName, decAmount);
	}
